...
export function StatTile({ label, value, hint }: { label: string; value: string; hint?: string }) {
  return (
    <div className="corner-cut-sm border border-slate-200/80 bg-slate-50/85 p-4 dark:border-slate-800 dark:bg-white/5">
      ...
      {/* Optional second line for what the value was computed OVER — a rating
          is only as meaningful as the population behind it, and a tile that
          responds to filters has to say how many players it is averaging. */}
