...
export function StadiumDatabaseMenu({ triggerClassName }: { triggerClassName?: string } = {}) {
  ...
  return (
    <div className="relative">
      ...
      <CenteredModalPanel open={isOpen} onClose={() => setIsOpen(false)} widthRem={42} eyebrow="Stadium Database" title="Correct or add stadium locations.">
        ...
        <div className="mt-4 grid grid-cols-[13rem,1fr] gap-4">
