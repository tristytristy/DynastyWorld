export function Navbar() {
  ...
  return (
    <header className="relative z-20 px-4 pt-4 md:px-6 md:pt-6">
      <div className="mx-auto flex max-w-[1600px] items-center border border-slate-900/10 bg-white/85 px-5 py-3.5 shadow-[0_24px_80px_-36px_rgba(15,23,42,0.24)] backdrop-blur-md dark:border-white/10 dark:bg-[#0e0f12]">
        <img
