...
<body>
  <div class="wrap">
    <header>
      ...
      <p class="generated">Exported from College Football 27 Dynasty Hub on ${escapeHtml(generatedAt)}</p>
    </header>
    ...
    <footer>Generated by College Football 27 Dynasty Hub — a local-first EA Sports College Football 27 dynasty tracker.</footer>
  </div>
</body>
</html>`;
}
