export const IPC = {
  ...
  db: {
    ...
    findLeaguePlayerTeam: 'db:findLeaguePlayerTeam',
    ...
    getCoachLeaderboards: 'db:getCoachLeaderboards',
    ...
    getLeagueRivalries: 'db:getLeagueRivalries',
  ...
  media: {
    ...
    setAlbumCover: 'media:setAlbumCover',
    listCustomAlbums: 'media:listCustomAlbums',
    createCustomAlbum: 'media:createCustomAlbum',
    renameCustomAlbum: 'media:renameCustomAlbum',
    removeCustomAlbum: 'media:removeCustomAlbum',
    setCustomAlbumCover: 'media:setCustomAlbumCover',
    update: 'media:update',
  ...
  net: {
    ...
    getThreads: 'net:getThreads',
    generateBoardWeek: 'net:generateBoardWeek',
    createThread: 'net:createThread',
    replyToThread: 'net:replyToThread',
